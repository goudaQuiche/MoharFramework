...
namespace MoharGfx
{
    public class Graphic_CutoutStackCount : Graphic_CutoutCollection
    {
        public override Material MatSingle => subGraphics[subGraphics.Length - 1].MatSingle;

        public override Graphic GetColoredVersion(Shader newShader, Color newColor, Color newColorTwo)
        {
            return GraphicDatabase.Get<Graphic_CutoutStackCount>(path, newShader, drawSize, newColor, newColorTwo, data);
        }
